    ...
    <section id="questionario">
      ...
      <div id="container">
        <div id="formulario">
          ...
          <form>
            <label class = 'label-formulario' for="">Questão 1:</label><br/>
            <input type="text" id="fname" class = 'input-formulario' name="fname"/><br/>
            <label class = 'label-formulario' for="">Questão 2:</label><br/>
            <input type="text" id="fname" class = 'input-formulario' name="fname"/><br/>
            <label class = 'label-formulario' for="">Questão 3:</label><br/>
            <input type="text" id="fname" class = 'input-formulario' name="fname"/><br/>
          </form>
        </div>
        <div id="foto">
