      ...
      <div class="violeta-header">
        ...
        <nav class="menu header-menu">
          <ul>
            ...
            <li><img class="icon-menu" src={iconDepoimento}/><a href="#depoimentos" class="violeta-bar-item violeta-btn">Depoimentos</a></li>
            <li><img class="icon-menu" src={iconGrafico}/><a href="#graficos" class="violeta-bar-item violeta-btn">Gráficos</a></li>
            <li><img class="icon-menu" src={iconProfissionais}/><a href="#profissionais" class="violeta-bar-item violeta-btn">Profissionais</a></li>
          </ul>
        </nav>
      </div>
  </header>
